...
class cartApi: NSObject {
    ...
    class func cartOption(url: String,product_id: String,qty:String,color: String,completion: @escaping(_ error: Error?,_ success: Bool,_ cart: Messages?,_ ErroMesage: sotkeMessage?,_ x: String?)-> Void){
